...
//skdgjr;gja;bneporbqe;nbelwbhepbeqvneqiupgh
...
public class OI {
    ...
    public OI() {
        ...
        rightBump.getBumperPressed(new slideRight());
        
        leftBump = gamePad.getBumper(left);
        leftBump.getBumperPressed(new slideLeft());
        
        if(gamepad.getY(left) != 0)
        {
        	new driveStraight();
        }
        ...
        joystick.getTriggerPressed(new closeClaw());
        
        climbButton = new JoystickButton(joystick, 3);
        climbButton.whenPressed(new climb());
        
        if(joystick.getY(joystickHand) > 0)
        {
        	new liftUp();
        }
        if(joystick.getY(joystickHand) < 0)
